...
For \textbf{\rupee 7,800} (approximately \$93 USD), you can build a complete satellite 
ground station capable of receiving LoRa IoT satellite signals at 868~MHz, weather 
satellite images at 137~MHz, aircraft positions at 1090~MHz, and amateur radio 
communications across the VHF/UHF spectrum.

The RTL-SDR Blog V4 is the cornerstone of this system — providing the radio reception 
capability that turns electromagnetic waves from space into digital data on your screen. 
Combined with OpenOrbitLink's Android app and Python backend, this creates a 
\textbf{complete, open-source, sub-\$100 satellite communication system} that works 
where no other connectivity exists.

\vspace{0.5cm}
\begin{center}
    \textit{``Making satellite connectivity accessible to everyone, everywhere.''}
    
    \textbf{OpenOrbitLink — \rupee 31 hardware, zero subscription, infinite possibilities.}
\end{center}
