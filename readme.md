...
| Direct commercial NTN | Future/convergence layer | App-layer encryption possible | Carrier required | Not an open satellite uplink and not implemented here. |
...
| `ANDROID_NTN` | No app RF | Carrier-managed | NTN bands | Only through carrier NTN stack. |
